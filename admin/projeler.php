					...
					if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
						...
						foreach ($_POST AS $k=>$v) {
							...
							if (substr($k,0,5) == "form_") {
								...
								$insert = $db->prepare("INSERT INTO ".TABLE." SET proje_baslik = ?, proje_seo = ?, proje_aciklama = ?, proje_kisaaciklama = ?, proje_keywords = ?,  proje_aktif = ?, proje_resim = ?, dil_id = ?, kategori_id = ?, proje_durum = ?, proje_ust_id = ?");
								$insert->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key], $proje_kisaaciklama[$key], $proje_keywords[$key], $proje_aktif[$key], $proje_resim, $key, $kategori_id, $proje_durum, $LastID));
													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<textarea class="form-control ckeditor" name="proje_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>
														
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Faydalar & Sonuçlar</label>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Nasıl Uygulanır</label>
																<textarea class="form-control ckeditor" name="proje_keywords[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>
														
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Aktif İçerikler</label>
																<textarea class="form-control ckeditor" name="proje_aktif[<?php echo $LANGUAGE_CODE; ?>]"></textarea>
															</div>
														</div>
					...
					if(isset($submitControl)){
						if(!empty($_POST['proje_baslik']) || !empty($_POST['proje_aciklama'])) {
							...
							foreach ($_POST AS $k=>$v) {
								...
								if (substr($k,0,5) == "form_") {
									$key = str_replace("form_","",$k);
									$update = $db->prepare("UPDATE ".TABLE." SET  proje_baslik = ?, proje_seo = ?, proje_aciklama = ?, proje_kisaaciklama = ?, proje_keywords = ?, proje_aktif = ?, proje_resim = ?, proje_durum = ?, kategori_id = ? WHERE proje_ust_id = ? AND dil_id = ?");
									$update->execute(array($proje_baslik[$key], Seo_Link_Cevir($proje_baslik[$key]), $proje_aciklama[$key], $proje_kisaaciklama[$key], $proje_keywords[$key], $proje_aktif[$key], $proje_resim, $proje_durum, $kategori_id, $id, $key));
								}
							}
							if ($update) {
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Kısa Açıklama</label>
																<textarea class="form-control ckeditor" name="proje_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("proje_kisaaciklama",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Nasıl Uygulanır</label>
																<textarea class="form-control ckeditor" name="proje_keywords[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("proje_keywords",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Aktif İçerikler</label>
																<textarea class="form-control ckeditor" name="proje_aktif[<?php echo $LANGUAGE_CODE; ?>]"><?php echo GetTableValue("proje_aktif",TABLE,"where proje_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?></textarea>
															</div>
														</div>
													</div>
													<input type="hidden" name="form_<?php echo $LANGUAGE_CODE; ?>" value="<?php echo $LANGUAGE_CODE; ?>" />
