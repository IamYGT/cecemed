            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li>
                     ...
                     <li>
						<a class="ai-icon" href="bayiler" aria-expanded="false">
							<i class="far fa-newspaper"></i>
							<span class="nav-text">Bayiler</span>
						</a> 
                    </li>
                     <li>
						<a class="ai-icon" href="urunslayt" aria-expanded="false">
							<i class="far fa-newspaper"></i>
							<span class="nav-text">Ürün Slayt</span>
						</a> 
                    </li>
		   
                     <li>
						<a class="ai-icon" href="slaytalti" aria-expanded="false">
							<i class="far fa-newspaper"></i>
							<span class="nav-text"> Slayt Altı</span>
						</a> 
                    </li>
