<?php require("../include/baglan.php");include("../include/fonksiyon.php"); 
		...
		define('TABLE',"urunslayt");
		define('AREA',"urunslayt");
		if(!isset($do)) $do = null; 
		$sayfa = (isset($q) ? $q : 1);
													...
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																...
																<input type="text" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="Başlık 2" required="">
															</div>
														</div> 
														 
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i> Başlık 3</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder="  Başlık 3" required="">
															</div>
														</div>  													
												...
												<div class="step-tab-panel" data-step="step<?php echo $LANGUAGE_ID; ?>">
													<div class="row">
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>  Başlık 2</label>
																<input type="text" name="haber_description[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Başlık 2" required="" value="<?php echo GetTableValue("haber_description",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
														...
														<div class="col-lg-12 mb-2">
															<div class="form-group">
																<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>  Başlık 3</label>
																<input type="text" name="haber_kisaaciklama[<?php echo $LANGUAGE_CODE; ?>]" class="form-control" placeholder=" Başlık 3" required="" value="<?php echo GetTableValue("haber_kisaaciklama",TABLE,"where haber_ust_id = {$id} and dil_id = '{$LANGUAGE_CODE}' "); ?>">
															</div>
														</div>
