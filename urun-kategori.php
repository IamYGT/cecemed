          ...
          <article class="col-main">
            <div class="category-products">
              <ul class="products-grid">
								<?php
               $altkatlar = $db->query("SELECT * FROM kategoriler WHERE altkategori_id = ".$tekil_veri_cek["kategori_id"]." AND dil_id = 'tr'");
             foreach($altkatlar as $tekil_veri_cek2){
							$veri_cek = $db->query("SELECT * FROM projeler WHERE proje_durum = 1 AND dil_id = 'tr' AND kategori_id=".$tekil_veri_cek2["kategori_id"]." ORDER BY proje_ust_id DESC LIMIT 99");
							if ($veri_cek->rowCount()){
							foreach($veri_cek as $veri_listele){
