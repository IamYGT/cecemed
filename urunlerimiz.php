...
<html lang="tr">
<head>
<title>Ürünlerimiz - Cecemed Saç Bakım Ürünleri </title>
<?php include("css.php")?>
</head>
...
<div id="page">
 ...
 <div class="featured-branding__branding">
    ...
    <!-- Breadcrumbs -->
		  ...
		  <div class="row">
			<div class="col-xs-12">
			  <ul>
				...
				<li class="category1599"> <a href="#" title="">Ürünlerimiz</a> </li>
			  </ul>
			</div>
		  </div>
		</div>
	  ...
	  <!-- Breadcrumbs End -->
	<h1 class="branding__title reset-font-weight">Ürünlerimiz</h1>
	</div>
  </div>
          ...
          <article class="col-main">
            <div class="category-products">
              <ul class="products-grid">
                                     <?php
				$veri_cek = $db->query("SELECT * FROM projeler WHERE proje_durum = 1 AND dil_id = 'tr' ORDER BY proje_ust_id DESC LIMIT 99");
 				if ($veri_cek->rowCount()){
				foreach($veri_cek as $veri_listele){
