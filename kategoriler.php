<?php require("include/baglan.php"); include("include/fonksiyon.php"); include_once("inc.lang.php");
	$row_info = $db->query("SELECT * FROM kategoriler WHERE kategori_ust_id = {$catname3} AND dil_id = 'tr'")->fetch(PDO::FETCH_ASSOC);

 ?>
<!DOCTYPE html>
<html lang="tr">
<head>
<title><?php echo $row_info["kategori_baslik"]; ?> - Cecemed Saç Bakım Ürünleri </title>
<?php include("css.php")?>
</head>
...
<div id="page">
 ...
 <div class="featured-branding__branding">
    ...
    <!-- Breadcrumbs -->
		  ...
		  <div class="row">
			<div class="col-xs-12">
			  <ul>
				...
				<li class="category1599"> <a href="#" title=""><?php echo $row_info["kategori_baslik"]; ?></a> </li>
			  </ul>
			</div>
		  </div>
		</div>
	  ...
	  <!-- Breadcrumbs End -->
	<h1 class="branding__title reset-font-weight"><?php echo $row_info["kategori_baslik"]; ?></h1>
	</div>
  </div>
          ...
          <article class="col-main">
            <div class="category-products">
              <ul class="products-grid">
                           <?php
				$veri_cek = $db->query("SELECT * FROM projeler WHERE proje_durum = 1 AND kategori_id = {$catname3} AND dil_id = 'tr' ORDER BY proje_ust_id DESC LIMIT 99");
 				if ($veri_cek->rowCount()){
				foreach($veri_cek as $veri_listele){
                  ...
                  <div class="item-inner">
                        <div class="productborder">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="<?php echo 	$veri_listele["proje_baslik"]; ?>" href="<?php echo $ayarlar["strURL"]; ?>/urun/<?php echo $veri_listele["proje_seo"]; ?>">
															<img style=" margin-top: 23px;   margin-bottom: 23px;" alt="<?php echo 	$veri_listele["proje_baslik"]; ?>" src="<?php echo $ayarlar["strURL"]; ?>/uploads/projects/<?php echo $veri_listele["proje_resim"]; ?>"> </a>
